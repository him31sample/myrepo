...
export function KundalisFilter({ listLoading }) {
  // Kundalis UI Context
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(kundalisUIProps.queryParams, values);
    if (!isEqual(newQueryParams, kundalisUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      kundalisUIProps.setQueryParams(newQueryParams);
    }
  };
