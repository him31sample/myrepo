...
export function HeaderMenu({ layoutProps }) {
    ...
    return <div
        ...
        <ul className={`menu-nav ${layoutProps.ulClasses}`}>
            ...
            {/*begin::1 Level*/}
            <li className={`menu-item menu-item-rel ${getMenuItemActive('/kundali')}`}>
                <NavLink className="menu-link" to="/kundali">
                    <span className="menu-text">Kundali</span>
                    {layoutProps.rootArrowEnabled && (<i className="menu-arrow" />)}
                </NavLink>
            </li>
            {/*end::1 Level*/}
            ...
            {/*begin::1 Level*/}
            <li className={`menu-item menu-item-rel ${getMenuItemActive('/astrologer')}`}>
            ...
            {/*begin::1 Level*/}
            <li className={`menu-item menu-item-rel ${getMenuItemActive('/horoscope')}`}>
                <NavLink className="menu-link" to="/horoscope">
                    <span className="menu-text">Horoscope</span>
                    {layoutProps.rootArrowEnabled && (<i className="menu-arrow" />)}
                </NavLink>
            </li>
            {/*end::1 Level*/}
